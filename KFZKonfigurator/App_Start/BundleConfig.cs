...
namespace KFZKonfigurator
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles) {
            ...
            bundles.Add(new ScriptBundle("~/bundles/divers").Include("~/Scripts/Framework/jquery-3.3.1.js", "~/Scripts/Framework/underscore.js", "~/Scripts/Framework/modernizr-2.6.2.js"));
